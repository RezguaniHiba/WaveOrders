<nav class="navbar navbar-expand-lg bg-white shadow-sm">
    <div class="container-fluid">
        ...
        <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#adminNav" aria-expanded="false" aria-label="Toggle navigation">
       ...
       <div class="collapse navbar-collapse" id="adminNav">
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link @if(request()->routeIs('admin.clients.*')) active @endif" href="{{ route('admin.clients.index') }}">
                ...
                <li class="nav-item">
                    <a class="nav-link @if(request()->routeIs('reglements.*')) active @endif" href="{{ route('reglements.index') }}">
                ...
                <li class="nav-item">
                    <a class="nav-link @if(request()->routeIs('users.*')) active @endif" href="{{ route('users.index') }}">
                        <i class="fas fa-user-cog me-1"  style="font-size: 0.9rem;"></i>
